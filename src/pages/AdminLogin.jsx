...
function DemoHint() {
  ...
  return (
    <p className="mt-4 rounded-lg bg-paper px-3 py-2 text-center text-xs text-muted">
      <strong>Demo:</strong> HQ → <code>{hq.username}</code> / <code>{hq.password}</code> · School → <code>{school.username}</code> / <code>{school.password}</code>
    </p>
  )
}
    ...
    <div className="mx-auto max-w-md px-4 py-12">
      <Card className="overflow-hidden">
        ...
        <div className="p-6">
          ...
          <h1 className="mt-4 text-center font-display text-2xl font-medium text-navy">Admin Login</h1>
          <p className="mt-1 text-center text-sm text-muted">For Tzivos Hashem HQ and school offices.</p>
