        ...
        <div className="overflow-x-auto">
          <table className="w-full min-w-[760px] border-collapse text-sm">
            <thead>
              ...
              <tr>
                <th /><th />
                {LULAV_DAYS.map((d) => <th key={d} className={`${th} text-center`}>{d}</th>)}
                <th /><th /><th />
              </tr>
            </thead>
            <tbody>
            ...
            <tfoot>
              <tr className="border-t-2 border-line font-semibold text-navy">
                <td className={`${td} font-cond text-[11px] uppercase tracking-wide`} colSpan={2 + LULAV_DAYS.length}>Totals</td>
